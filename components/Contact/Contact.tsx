        ...
        <div className="contact-content max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 rounded-full bg-apple-swift px-8 py-4 text-body-md font-medium text-white transition-all hover:brightness-110 hover:shadow-lg hover:shadow-apple-swift/25"
            >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 rounded-full border border-white/20 px-8 py-4 text-body-md font-medium text-white transition-all hover:bg-white/10"
            >
